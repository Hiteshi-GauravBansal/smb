...
class SambaBrowser {
  ...
  static Future<String> uploadFile(String fileName, String url, String domain,
    ...
    final String result = await _channel.invokeMethod('uploadFile', args);
    return result;
  }

  static Future<String> deleteFile(String fileName, String url, String domain,
      String username, String password) async {
    Map<String, String> args = {
      'fileName': fileName,
      'url': url,
    ...
    final String result = await _channel.invokeMethod('deleteFile', args);
    return result;
  }
}
